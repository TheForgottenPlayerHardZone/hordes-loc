export default {
  interactions: [{
    ...
    text: {
      ...
      ru: 'Вы слышали о Crystal Shards, которые были недавно обнаружены? Путешественники могут использовать их для мгновенного путешествия в дальние королевства. У меня сейчас нету таких Shards, но я могу переместить вас в некоторые места, так как на этом нексусе сходятся мистические силы. В какое королевство вы хотите попасть?',
